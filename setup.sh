...
echo ""
echo "Usage:"
echo "  GUI mode:          uv run python main.py"
echo "  Command line:      uv run python cli.py"
echo "  Run tests:         uv run python -m pytest test_tracker.py"
echo ""
echo "For detailed VRChat setup instructions, see vrchat_setup.md."
